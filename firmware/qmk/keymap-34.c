...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_GAM] = LAYOUT_split_3x5_2(
        KC_TAB,    KC_Q,      KC_X,      KC_E,      KC_R,             KC_NONE,   KC_NONE,   KC_NONE,      KC_NONE,     KC_TAB,
        KC_LSFT,   KC_A,      KC_W,      KC_D,      KC_F,             KC_NONE,   KC_LEFT,   KC_UP,        KC_RGHT,     KC_RSFT,
        KC_LCTL,   KC_Z,      KC_S,      KC_C,      KC_V,             KC_NONE,   KC_NONE,   KC_DOWN,      KC_NONE,     KC_RCTL,
                                         KC_SPC,    LA_GFN,           DF(_DEF),  KC_PSCR
    ),

    [_GFN] = LAYOUT_split_3x5_2(
        KC_ESC,    KC_1,      KC_2,      KC_3,      KC_4,             KC_NONE,   KC_NONE,   KC_NONE,      KC_NONE,     KC_NONE,
        KC_LALT,   KC_5,      KC_6,      KC_7,      KC_8,             KC_NONE,   KC_NONE,   KC_NONE,      KC_NONE,     KC_NONE,
        KC_G,      KC_J,      KC_I,      KC_M,      KC_T,             KC_NONE,   KC_NONE,   KC_NONE,      KC_NONE,     KC_NONE,
                                         KC_ENT,    _______,          KC_NONE,   KC_NONE
    ),
    ...
    [_NAV] = LAYOUT_split_3x5_2(
        ...
        SPACE_L,   SPACE_R,   DF(_GAM),  KC_PSCR,   KC_TAB,           KC_TAB,    KC_PGUP,   KC_PGDN,      KC_QUOT,     KC_NUM,
                                         LA_CMD,    _______,          _______,   KC_CAPS
    ),
